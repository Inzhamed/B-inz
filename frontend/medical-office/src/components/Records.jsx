          ...
          <div className="flex justify-center my-10">
            <div className="w-[70rem] h-96 bg-neutral-100 rounded-2xl shadow-lg pl-14 pt-9">
              ...
              {patients.map((patient) => (
                <div
                  key={patient.id}
                  className="w-[41rem] h-32 flex flex-col gap-4 mb-4 p-4 bg-white rounded-lg shadow"
                >
                  <div className="flex gap-24">
                    <div className="w-20 flex-col gap-1 flex">
                    ...
                    <div className="w-80 flex-col gap-1 flex">
                      <div className="text-zinc-400 text-xs font-semibold">
                        Phone Number
                      </div>
